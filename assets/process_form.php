...
if ($conn->query($updateUserQuery) === TRUE) {
    ...
    $insertAddressQuery = "INSERT INTO c_address (c_id, address_line1, address_line2, city, state, postal_code) VALUES ($userID, '$address1', '$address2', '$city', '$state', '$postalCode')";
