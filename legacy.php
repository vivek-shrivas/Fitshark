...
WHERE c.category_name = 'LEGACY' AND p.is_deleted = 0";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<div class="product-card" onmouseover="startImageChange(this)" onmouseout="stopImageChange(this)" onclick="loadProductDetails(' . $row["product_id"] . ')" data-product-id="' . $row["product_id"] . '">';
